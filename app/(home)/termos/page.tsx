          ...
          <Card className="bg-white/80 backdrop-blur-xl shadow-xl border-white/50 p-8 md:p-12 mb-8">
            <div className="prose prose-lg prose-blue max-w-none">
              ...
              <div className="flex items-center gap-4 mb-8 p-6 bg-blue-50 rounded-2xl border border-blue-100">
                ...
                <div>
                  <h3 className="text-lg font-bold text-blue-900 m-0">Acordo Legal</h3>
                  <p className="text-blue-700 m-0 text-sm">
                    Este é um contrato vinculativo entre você e a Candle Consultoria.
                  </p>
                </div>
              </div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Ao acessar e usar a plataforma ConsultaAi, você confirma que leu, entendeu e aceita estes Termos de Uso. 
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                A ConsultaAi fornece uma plataforma para consultas de crédito e dados públicos de pessoas físicas e jurídicas.
              ...
              <p className="text-gray-600 leading-relaxed">
                A ConsultaAi atua como intermediária de informações. Não garantimos a precisão absoluta de dados fornecidos por fontes terceiras (bureaus de crédito, órgãos públicos) e não nos responsabilizamos por decisões tomadas com base nessas informações.
              </p>
